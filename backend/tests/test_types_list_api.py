...
def test_get_types_returns_empty_list_for_empty_database(client: TestClient, db_engine) -> None:
...
def test_get_types_returns_sorted_types_with_all_stage_counts(
